...
INNER JOIN vendor_booth_assignments
    ON v.vendor_id=vendor_booth_assignments.vendor_id
...
sticker to everyone who has ever spent more than $2000 at the market(农夫市场的顾客感谢委员会想要找出所有在市场消费总额超过 2000 美元的顾客. Write a query that generates a list 
...
JOIN customer_purchases 
  ON c.customer_id = customer_purchases.customer_id
